  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      icon: FaLinkedin,
      url: 'https://linkedin.com/in/tonguino-gaston-pascal',
      color: 'hover:text-[#0077B5]',
    },
    {
      name: 'GitHub',
      icon: FaGithub,
      url: 'https://github.com/tonguino-gaston',
      color: 'hover:text-white',
    },
  ];

  return (
    <footer className="relative bg-dark-900 border-t border-white/10 py-8">
